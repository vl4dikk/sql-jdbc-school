...
public class StudentDao {
	...
	private static final String ASSIGN_TO_COURSE_QUERY = "INSERT INTO students_courses (student_id, course_id) "
			+ "     VALUES (?, ?)";
	private static final String INSERT_STUDENTS_QUERY = "INSERT INTO students (group_id, first_name, last_name) "
			+ "     VALUES (?, ?, ?)";
	...
	private static final String DELETE_FROM_COURSE = "DELETE " + "  FROM students_courses " + " WHERE student_id = ? "
			+ "   AND course_id = ?";
